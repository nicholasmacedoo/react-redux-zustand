...
import { PlayerState, next, play, playerSlice, player as reducer } from "./player";
...
describe('Player slice', () => {
    ...
    it('should not update the curren module and lesson index if therer is no next lesson available', () => {
